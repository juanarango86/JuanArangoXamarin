...
using JuanArangoXamarinApp.Helpers.HttpMessageHandlers;
...
{   
    public class Startup
    {
        ...
        private const string SERVICES_NAMESPACE = "JuanArangoXamarinApp.Services";
        //private const string SINGLE_INSTANCE_SERVICES_NAMESPACE = "ExampleApp.Services.SingleInstance";
        private const string VIEW_MODELS_NAMESPACE = "JuanArangoXamarinApp.ViewModels";
        ...
        static Startup()
        {
            ...
            //para cada interfaz se debe definir utilizando libreria refit
